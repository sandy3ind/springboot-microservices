...
import com.samplerestaurantservice.respository.RestaurantOfferRepository;
...
@RestController
@RequestMapping("/{restaurantId}/offer")
public class RestaurantOfferService {
	...
	public ResponseEntity<?> save(
			...
			@Valid @RequestBody RestaurantOffer restaurantOffer, Errors errors) {
		...
		restaurantOfferRepository.save(restaurantOffer);
